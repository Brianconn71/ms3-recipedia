...
$(".add_ingredient").click(function(e){
    ...
    if(ingred < max_ingred){
        ...
        <a type="button" class="btn red remove_ingredient"><i class="far fa-minus-square"></i>Remove Ingredient</a></div>`)
    }
})
...
$(".add_step").click(function(e){
    ...
    if(step < max_steps){
        ...
        <a type="button" class="btn red remove_step"><i class="far fa-minus-square"></i>Remove Step</a></div>`)
    }
})
